...
from scvi.module import SCPEAKVAE
...
class SCPEAKVI(ArchesMixin, VAEMixin, UnsupervisedTrainingMixin, BaseModelClass):
    """
    SCVI - PeakVI.
    ...
    **model_kwargs
    ...
    def __init__(
        ...
        **model_kwargs,
        ...
        super(SCPEAKVI, self).__init__(adata)
